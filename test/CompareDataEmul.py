...
#evtsTree.Draw("fg1_emul:fg1>>fg1_corr")
#evtsTree.Draw("fg0_emul:fg0>>fg0_corr")
#evtsTree.Draw("fg2_emul:fg2>>fg2_corr")
#evtsTree.Draw("fg3_emul:fg3>>fg3_corr")
#evtsTree.Draw("fg4_emul:fg4>>fg4_corr")
#evtsTree.Draw("fg5_emul:fg5>>fg5_corr")
#evtsTree.Draw("fg6_emul:fg6>>fg6_corr")
...
#evtsTree.Draw("iphi:ieta>>ieta_iphi", "adc2+adc3==adc2_emul+adc3_emul && et > 0")
evtsTree.Draw("iphi:ieta>>ieta_iphi", "soi!=soi_emul")
...
c.SaveAs("test/hists_345386/ietaViphi.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr13.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr14.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr15.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr16.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr17.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr18.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr19.png")
...
c.SetLogz()
c.SetRightMargin(0.15)
c.SaveAs("test/hists_345386/et_corr20.png")
